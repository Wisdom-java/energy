...
public class HBaseDAO {
    ...
    public HBaseDAO() {
        try {
            regions = Integer.valueOf(PropertiesUtil.getProperty("hbase.test2.regions"));
            namespace = PropertiesUtil.getProperty("hbase.test2.namespace");
            tableName = PropertiesUtil.getProperty("hbase.test2.tablename");
